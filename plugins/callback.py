...
### новая версия реализации коллбэк функции

async def search_vacancy(m: Updater,
                         systems: Systems):
    user_id = m.get_user_id()
    chat_id = m.get_chat_id()
    text = m.get_text()
...
async def next_vacancy(m: Updater,
                       systems: Systems):
    user_id = m.get_user_id()
    chat_id = m.get_chat_id()
    message_id = m.get_message_id()
...
async def get_vacancy(m: Updater,
                      systems: Systems):
    chat_id = m.get_chat_id()
    if await systems.local_cache.check(chat_id):
        await next_vacancy(m, systems)
    else:
        await search_vacancy(m, systems)


async def add_vacancy_to_favorites(m: Updater,
                                   systems: Systems):
    user_id = m.get_user_id()
    chat_id = m.get_chat_id()
    message_id = m.get_message_id()
...
async def history_viewed_vacancy(m: Updater,
                                 systems: Systems):
    user_id = m.get_user_id()
    chat_id = m.get_chat_id()
    message_id = m.get_message_id()
...
async def viewed_history_already_cleaned(m: Updater,
                                         systems: Systems):
    user_id = m.get_user_id()
    chat_id = m.get_chat_id()
    message_id = m.get_message_id()
...
async def add_vacancy_to_history(m: Updater,
                                 systems: Systems):
    user_id = m.get_user_id()
    chat_id = m.get_chat_id()
    message_id = m.get_message_id()
...
async def show_favor_vacancy(m: Updater,
                             systems: Systems):
    chat_id = m.get_chat_id()
...
async def return_to_init_state(m: Updater,
                               systems: Systems):
    await hello_message(m, systems)


async def uncover_vacancy_info(m: Updater,
                               systems: Systems):
    chat_id = m.get_chat_id()
    message_id = m.get_message_id()
    extend_profile: bool = False
...
async def get_extend_vacancy(m: Updater,
                             systems: Systems):
    chat_id = m.get_chat_id()
    message_id = m.get_message_id()
    extend_profile: bool = False
...
async def nothing_found(m: Updater,
                        system: Systems):
    chat_id = m.get_chat_id()
